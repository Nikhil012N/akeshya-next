    ...
    <section id="hero" className="flex items-center min-h-screen bg-gray-100">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap">
          <div className="w-full lg:w-1/2 pt-5 lg:pt-0 order-2 lg:order-1 flex flex-col justify-center">
          ...
          <div className="w-full lg:w-1/2 order-1 lg:order-2 flex justify-center" data-aos="fade-left" data-aos-delay="200">
